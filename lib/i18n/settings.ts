...
export const settingsCa = {
  settings: {
    title: 'Configuració',
    description: 'Configura els paràmetres de l\'aplicació',
    language: 'Idioma',
    languageDesc: 'Seleccioneu l\'idioma de la interfície',
    theme: 'Tema',
    themeDesc: 'Seleccioneu el mode de tema (Clar/Fosc/Sistema)',
    themeOptions: {
      light: 'Clar',
      dark: 'Fosc',
      system: 'Sistema',
    ...
    apiKey: 'Clau API',
    apiKeyDesc: 'Configureu la vostra clau API',
    apiBaseUrl: 'URL de l\'endpoint API',
    apiBaseUrlDesc: 'Configureu la URL de l\'endpoint API',
    apiKeyRequired: 'La clau API no pot estar buida',
    model: 'Configuració del model',
    modelDesc: 'Configureu models IA',
    modelPlaceholder: 'Introduïu o seleccioneu el nom del model',
    ttsModel: 'Model TTS',
    ttsModelDesc: 'Configureu models TTS',
    ttsModelPlaceholder: 'Introduïu o seleccioneu el nom del model TTS',
    ttsModelOptions: {
      openaiTts: 'OpenAI TTS',
      azureTts: 'Azure TTS',
    },
    availableModels: 'Models disponibles',
    modelSelectedViaVoice: 'El model es determina per la selecció de veu',
    testConnection: 'Provar connexió',
    testConnectionDesc: 'Proveu si la configuració API actual és disponible',
    testing: 'Provant...',
    agentSettings: 'Configuració d\'agents',
    agentSettingsDesc:
      'Seleccioneu els agents per participar a la conversa. Seleccioneu 1 per al mode d\'agent únic, seleccioneu múltiples per al mode col·laboratiu multi-agent.',
    agentMode: 'Mode d\'agent',
    agentModePreset: 'Preestablert',
    agentModeAuto: 'Generació automàtica',
    agentModeAutoDesc: 'La IA generarà automàticament rols adequats',
    autoAgentCount: 'Nombre d\'agents',
    autoAgentCountDesc: 'Nombre d\'agents a generar automàticament (inclou el professor)',
    atLeastOneAgent: 'Seleccioneu almenys 1 agent',
    singleAgentMode: 'Mode d\'agent únic',
    directAnswer: 'Resposta directa',
    multiAgentMode: 'Mode multi-agent',
    agentsCollaborating: 'Discussió col·laborativa',
    agentsCollaboratingCount: '{count} agents seleccionats per a la discussió col·laborativa',
    maxTurns: 'Torns màxims de discussió',
    maxTurnsDesc:
      'El nombre màxim de torns de discussió entre agents (cada agent completa accions i respon compta com un torn)',
    priority: 'Prioritat',
    actions: 'Accions',
    actionCount: '{count} accions',
    selectedAgent: 'Agent seleccionat',
    selectedAgents: 'Agents seleccionats',
    required: 'Obligatori',
    agentNames: {
      'default-1': 'Professor IA',
      'default-2': 'Assistent IA',
      'default-3': 'Animador de classe',
      'default-4': 'Ment curiosa',
      'default-5': 'Apuntador',
      'default-6': 'Pensador profund',
    },
    agentRoles: {
      teacher: 'Professor',
      assistant: 'Assistent',
    ...
    agentDescriptions: {
      'default-1': 'Professor principal amb explicacions clares i estructurades',
      'default-2': 'Dona suport a l\'aprenentatge i ajuda a aclarir els punts clau',
      'default-3': 'Aporta humor i energia a l\'aula',
      'default-4': 'Sempre curiós, li encanta preguntar el per què i el com',
      'default-5': 'Registra i organitza diligentment les notes de classe',
      'default-6': 'Pensa profundament i explora l\'essència dels temes',
    },
    close: 'Tancar',
    save: 'Desar',
    // Provider settings
    providers: 'LLM',
    addProviderDescription: 'Afegiu proveïdors de models personalitzats per ampliar els models IA disponibles',
    providerNames: {
      openai: 'OpenAI',
      anthropic: 'Claude',
      google: 'Gemini',
    ...
    documentParser: 'Analitzador de documents',
    conversationSettings: 'Conversa',
    keyboardShortcuts: 'Dreceres',
    generalSettings: 'General',
    systemSettings: 'Sistema',
    addProvider: 'Afegir',
    importFromClipboard: 'Importar del porta-retalls',
    apiSecret: 'Clau API',
    apiHost: 'Base URL',
    requestUrl: 'URL de sol·licitud',
    models: 'Models',
    addModel: 'Nou',
    reset: 'Restablir',
    fetch: 'Obtenir',
    ...
    contextShort: 'ctx',
    outputWindow: 'Sortida',
    // Provider management
    addProviderButton: 'Afegir',
    addProviderDialog: 'Afegir proveïdor de model',
    providerName: 'Nom',
    providerNamePlaceholder: 'p. ex., El meu proxy OpenAI',
    providerNameRequired: 'Introduïu el nom del proveïdor',
    providerApiMode: 'Mode API',
    apiModeOpenAI: 'Protocol OpenAI',
    apiModeAnthropic: 'Protocol Claude',
    apiModeGoogle: 'Protocol Gemini',
    defaultBaseUrl: 'Base URL per defecte',
    providerIcon: 'URL de la icona del proveïdor',
    requiresApiKey: 'Requereix clau API',
    deleteProvider: 'Eliminar proveïdor',
    deleteProviderConfirm: 'Esteu segurs que voleu eliminar aquest proveïdor?',
    cannotDeleteBuiltIn: 'No es pot eliminar el proveïdor integrat',
    resetToDefault: 'Restablir valors per defecte',
    resetToDefaultDescription:
      'Restaura la llista de models a la configuració per defecte (la clau API i la Base URL es conservaran)',
    resetConfirmDescription:
      'Això eliminarà tots els models personalitzats i restaurarà la llista de models per defecte integrada. La clau API i la Base URL es conservaran.',
    confirmReset: 'Confirmar restabliment',
    resetSuccess: 'S\'ha restablit correctament a la configuració per defecte',
    saveSuccess: 'Configuració desada',
    saveFailed: 'Error en desar la configuració, torneu-ho a intentar',
    cannotDeleteBuiltInModel: 'No es pot eliminar el model integrat',
    cannotEditBuiltInModel: 'No es pot editar el model integrat',
    modelIdRequired: 'Introduïu l\'ID del model',
    noModelsAvailable: 'No hi ha models disponibles per a les proves',
    providerMetadata: 'Metadades del proveïdor',
    // Model editing
    editModel: 'Editar model',
    editModelDescription: 'Editeu la configuració i les capacitats del model',
    addNewModel: 'Nou model',
    addNewModelDescription: 'Afegiu una nova configuració de model',
    modelId: 'ID del model',
    modelIdPlaceholder: 'p. ex., gpt-4o',
    modelName: 'Nom de visualització',
    modelNamePlaceholder: 'Opcional',
    modelCapabilities: 'Capacitats',
    advancedSettings: 'Configuració avançada',
    contextWindowLabel: 'Finestra de context',
    contextWindowPlaceholder: 'p. ex., 128000',
    outputWindowLabel: 'Tokens de sortida màxims',
    outputWindowPlaceholder: 'p. ex., 4096',
    testModel: 'Provar model',
    deleteModel: 'Eliminar',
    cancelEdit: 'Cancel·lar',
    saveModel: 'Desar',
    modelsManagementDescription:
      'Gestioneu els models per a aquest proveïdor. Per seleccionar el model actiu, aneu a "General".',
    // General settings
    howToUse: 'Com utilitzar',
    step1ConfigureProvider:
      'Aneu a "Proveïdors de model", seleccioneu o afegiu un proveïdor i configureu els paràmetres de connexió (clau API, Base URL, etc.)',
    step2SelectModel: 'Seleccioneu el model que voleu usar a "Model actiu" a continuació',
    step3StartUsing: 'Després de desar, el sistema usarà el model seleccionat',
    activeModel: 'Model actiu',
    activeModelDescription: 'Seleccioneu el model per a les converses IA i la generació de contingut',
    selectModel: 'Seleccionar model',
    searchModels: 'Cercar models',
    noModelsFound: 'No s\'han trobat models coincidents',
    noConfiguredProviders: 'No hi ha proveïdors configurats',
    configureProvidersFirst:
      'Configureu els paràmetres de connexió del proveïdor a "Proveïdors de model" a l\'esquerra',
    currentlyUsing: 'Usant actualment',
    // TTS settings
    ttsSettings: 'Síntesi de veu',
    // ASR settings
    asrSettings: 'Reconeixement de veu',
    // Audio settings (legacy)
    audioSettings: 'Configuració d\'àudio',
    ttsSection: 'Text a veu (TTS)',
    asrSection: 'Reconeixement automàtic de veu (ASR)',
    ttsDescription: 'TTS (Text a veu) - Converteix text en veu',
    asrDescription: 'ASR (Reconeixement automàtic de veu) - Converteix veu en text',
    enableTTS: 'Activar síntesi de veu',
    ttsEnabledDescription: 'Quan s\'activa, es generarà àudio de veu durant la creació del curs',
    ttsVoiceConfigHint:
      'La veu per agent es pot configurar a "Configuració de rols de l\'aula" a la pàgina d\'inici',
    enableASR: 'Activar reconeixement de veu',
    asrEnabledDescription: 'Quan s\'activa, els estudiants poden usar el micròfon per a l\'entrada de veu',
    ttsProvider: 'Proveïdor TTS',
    ttsLanguageFilter: 'Filtre d\'idioma',
    ...
    ttsApiKey: 'Clau API',
    doubaoAppId: 'App ID',
    doubaoAccessKey: 'Clau d\'accés',
    asrProvider: 'Proveïdor ASR',
    asrLanguage: 'Idioma de reconeixement',
    asrBaseUrl: 'Base URL',
    asrApiKey: 'Clau API',
    enterApiKey: 'Introduïu la clau API',
    enterCustomBaseUrl: 'Introduïu la Base URL personalitzada',
    browserNativeNote: 'L\'ASR natiu del navegador no requereix configuració i és completament gratuït',
    // Audio provider names
    providerOpenAITTS: 'OpenAI TTS (gpt-4o-mini-tts)',
    providerAzureTTS: 'Azure TTS',
    providerAzureFoundryTTS: 'Azure AI Foundry TTS',
    ...
    providerElevenLabsTTS: 'ElevenLabs TTS',
    providerMiniMaxTTS: 'MiniMax TTS',
    providerBrowserNativeTTS: 'TTS natiu del navegador',
    providerOpenAIWhisper: 'OpenAI ASR (gpt-4o-mini-transcribe)',
    providerBrowserNative: 'ASR natiu del navegador',
    providerQwenASR: 'Qwen ASR (Alibaba Cloud Bailian)',
    providerUnpdf: 'unpdf (Integrat)',
    providerMinerU: 'MinerU',
    browserNativeTTSNote:
      'El TTS natiu del navegador no requereix configuració i és completament gratuït, usant les veus integrades del sistema',
    testTTS: 'Provar TTS',
    testASR: 'Provar ASR',
    testSuccess: 'Prova correcta',
    testFailed: 'Prova fallida',
    ttsTestText: 'Text de prova TTS',
    ttsTestSuccess: 'Prova TTS correcta, àudio reproduït',
    ttsTestFailed: 'Prova TTS fallida',
    asrTestSuccess: 'Reconeixement de veu correcte',
    asrTestFailed: 'Reconeixement de veu fallat',
    asrResult: 'Resultat del reconeixement',
    asrNotSupported: 'El navegador no suporta l\'API de reconeixement de veu',
    browserTTSNotSupported: 'El navegador no suporta l\'API de síntesi de veu',
    browserTTSNoVoices: 'El navegador actual no té veus TTS disponibles',
    microphoneAccessDenied: 'Accés al micròfon denegat',
    microphoneAccessFailed: 'Error en accedir al micròfon',
    asrResultPlaceholder: 'El resultat del reconeixement es mostrarà després de la gravació',
    useThisProvider: 'Usar aquest proveïdor',
    fetchVoices: 'Obtenir llista de veus',
    fetchingVoices: 'Obtenint...',
    voicesFetched: 'Veus obtingudes',
    fetchVoicesFailed: 'Error en obtenir les veus',
    voiceApiKeyRequired: 'Es requereix clau API',
    voiceBaseUrlRequired: 'Es requereix Base URL',
    ttsTestTextPlaceholder: 'Introduïu el text a convertir',
    ttsTestTextDefault: 'Hola, aquesta és una prova de veu.',
    startRecording: 'Iniciar gravació',
    stopRecording: 'Aturar gravació',
    recording: 'Gravant...',
    transcribing: 'Transcrivint...',
    transcriptionResult: 'Resultat de la transcripció',
    noTranscriptionResult: 'Cap resultat de transcripció',
    baseUrlOptional: 'Base URL (Opcional)',
    defaultValue: 'Per defecte',
    // TTS Voice descriptions (OpenAI)
    voiceMarin: 'Recomanat - Millor qualitat',
    voiceCedar: 'Recomanat - Millor qualitat',
    voiceAlloy: 'Neutre, equilibrat',
    voiceAsh: 'Ferm, professional',
    voiceBallad: 'Elegant, líric',
    voiceCoral: 'Càlid, amigable',
    voiceEcho: 'Masculí, clar',
    voiceFable: 'Narratiu, vívid',
    voiceNova: 'Femení, brillant',
    voiceOnyx: 'Masculí, profund',
    voiceSage: 'Savi, compost',
    voiceShimmer: 'Femení, suau',
    voiceVerse: 'Natural, fluid',
    // TTS Voice descriptions (GLM)
    glmVoiceTongtong: 'Veu per defecte',
    glmVoiceChuichui: 'Veu Chuichui',
    glmVoiceXiaochen: 'Veu Xiaochen',
    glmVoiceJam: 'Veu Jam',
    glmVoiceKazi: 'Veu Kazi',
    glmVoiceDouji: 'Veu Douji',
    glmVoiceLuodo: 'Veu Luodo',
    // TTS Voice descriptions (Qwen)
    qwenVoiceCherry: 'Alegre, càlid i natural',
    qwenVoiceSerena: 'Suau i dolç',
    qwenVoiceEthan: 'Enèrgic i vibrant',
    qwenVoiceChelsie: 'Noia virtual anime',
    qwenVoiceMomo: 'Juganera i alegre',
    qwenVoiceVivian: 'Maca i atrevida',
    qwenVoiceMoon: 'Fresc i elegant',
    qwenVoiceMaia: 'Intel·lectual i suau',
    qwenVoiceKai: 'Un SPA per a les vostres orelles',
    qwenVoiceNofish: 'Dissenyadora que no pronuncia sons retroflex',
    qwenVoiceBella: 'Noia que no s\'emborratxa',
    qwenVoiceJennifer: 'Veu femenina americana de qualitat cinematogràfica',
    qwenVoiceRyan: 'Ritme ràpid, actuació dramàtica',
    qwenVoiceKaterina: 'Dona madura amb ritme memorable',
    qwenVoiceAiden: 'Noi americà expert en cuina',
    qwenVoiceEldricSage: 'Ancià estable i savi',
    qwenVoiceMia: 'Suau com l\'aigua de primavera',
    qwenVoiceMochi: 'Nen adult intel·ligent amb innocència infantil',
    qwenVoiceBellona: 'Veu potent, pronunciació clara',
    qwenVoiceVincent: 'Veu ronca única explicant històries',
    qwenVoiceBunny: 'Noia super maca',
    qwenVoiceNeil: 'Presentador de notícies professional',
    qwenVoiceElias: 'Instructor professional',
    qwenVoiceArthur: 'Veu senzilla impregnada d\'anys',
    qwenVoiceNini: 'Veu suau i enganxosa',
    qwenVoiceEbona: 'El seu murmuri és com una clau rovellada',
    qwenVoiceSeren: 'Veu suau i relaxant per ajudar-vos a dormir',
    qwenVoicePip: 'Entremaliat però ple d\'innocència infantil',
    qwenVoiceStella: 'Veu de noia dolça i confosa',
    qwenVoiceBodega: 'Oncle espanyol entusiasta',
    qwenVoiceSonrisa: 'Dona llatinoamericana entusiasta',
    qwenVoiceAlek: 'Fred com una nació guerrera, càlid sota l\'abric de llana',
    qwenVoiceDolce: 'Oncle italià mandrós',
    qwenVoiceSohee: 'Noia coreana amable i alegre',
    qwenVoiceOnoAnna: 'Amic d\'infància entremaliat',
    qwenVoiceLenn: 'Jove alemany racional que porta vestit i escolta post-punk',
    qwenVoiceEmilien: 'Germà gran francès romàntic',
    qwenVoiceAndre: 'Veu masculina magnètica, natural i tranquil·la',
    qwenVoiceRadioGol: 'Poeta del futbol Rádio Gol!',
    qwenVoiceJada: 'Senyora de Shanghai animada',
    qwenVoiceDylan: 'Noi de Pequín',
    qwenVoiceLi: 'Professora de ioga pacient',
    qwenVoiceMarcus: 'Cara ampla, paraules curtes, cor sòlid',
    qwenVoiceRoy: 'Noi taiwanès humorístic i directe',
    qwenVoicePeter: 'Suportador professional de comèdia Tianjin',
    qwenVoiceSunny: 'Noia de Sichuan dolça',
    qwenVoiceEric: 'Cavaller de Chengdu',
    qwenVoiceRocky: 'Noi de Hong Kong humorístic',
    qwenVoiceKiki: 'Noia de Hong Kong dolça',
    // ASR Language names (native forms - autoglossonyms)
    lang_auto: 'Detecció automàtica',
    lang_zh: '中文',
    lang_yue: '粤語',
    lang_en: 'English',
    lang_ja: '日本語',
    ...
    'lang_uk-UA': 'Українська (Україна)',
    // PDF settings
    pdfSettings: 'Anàlisi PDF',
    pdfParsingSettings: 'Configuració d\'anàlisi PDF',
    pdfDescription:
      'Trieu el motor d\'anàlisi PDF amb suport per a l\'extracció de text, processament d\'imatges i reconeixement de taules',
    pdfProvider: 'Analitzador PDF',
    pdfFeatures: 'Funcions suportades',
    pdfApiKey: 'Clau API',
    pdfBaseUrl: 'Base URL',
    mineruDescription:
      'MinerU és un servei comercial d\'anàlisi PDF que suporta funcions avançades com l\'extracció de taules, el reconeixement de fórmules i l\'anàlisi de disseny.',
    mineruApiKeyRequired: 'Heu de sol·licitar una clau API al lloc web de MinerU abans d\'usar-lo.',
    mineruWarning: 'Avís',
    mineruCostWarning:
      'MinerU és un servei comercial i pot generar despeses. Consulteu el lloc web de MinerU per obtenir detalls de preus.',
    enterMinerUApiKey: 'Introduïu la clau API de MinerU',
    mineruLocalDescription:
      'MinerU suporta desplegament local amb anàlisi PDF avançada (taules, fórmules, anàlisi de disseny). Requereix desplegar primer el servei MinerU.',
    mineruServerAddress: 'Adreça del servidor MinerU local (p. ex., http://localhost:8080)',
    mineruApiKeyOptional: 'Només necessari si el servidor té autenticació activada',
    optionalApiKey: 'Clau API opcional',
    featureText: 'Extracció de text',
    featureImages: 'Extracció d\'imatges',
    featureTables: 'Extracció de taules',
    featureFormulas: 'Reconeixement de fórmules',
    featureLayoutAnalysis: 'Anàlisi de disseny',
    featureMetadata: 'Metadades',
    // Image Generation settings
    enableImageGeneration: 'Activar generació d\'imatges IA',
    imageGenerationDisabledHint:
      'Quan s\'activa, es generaran imatges automàticament durant la creació del curs',
    imageSettings: 'Generació d\'imatges',
    imageSection: 'Text a imatge',
    imageProvider: 'Proveïdor de generació d\'imatges',
    imageModel: 'Model de generació d\'imatges',
    providerSeedream: 'Seedream (ByteDance)',
    providerQwenImage: 'Qwen Image (Alibaba)',
    providerNanoBanana: 'Nano Banana (Gemini)',
    providerMiniMaxImage: 'MiniMax Image',
    providerGrokImage: 'Grok Image (xAI)',
    testImageGeneration: 'Provar generació d\'imatges',
    testImageConnectivity: 'Provar connexió',
    imageConnectivitySuccess: 'Servei d\'imatges connectat correctament',
    imageConnectivityFailed: 'Error en la connexió del servei d\'imatges',
    imageTestSuccess: 'Prova de generació d\'imatges correcta',
    imageTestFailed: 'Prova de generació d\'imatges fallida',
    imageTestPromptPlaceholder: 'Introduïu la descripció de la imatge per a la prova',
    imageTestPromptDefault: 'Un gat maco assegut a un escriptori',
    imageGenerating: 'Generant imatge...',
    imageGenerationFailed: 'Error en la generació d\'imatges',
    // Video Generation settings
    enableVideoGeneration: 'Activar generació de vídeo IA',
    videoGenerationDisabledHint:
      'Quan s\'activa, es generaran vídeos automàticament durant la creació del curs',
    videoSettings: 'Generació de vídeo',
    videoSection: 'Text a vídeo',
    videoProvider: 'Proveïdor de generació de vídeo',
    videoModel: 'Model de generació de vídeo',
    ...
    providerGrokVideo: 'Grok Video (xAI)',
    testVideoGeneration: 'Provar generació de vídeo',
    testVideoConnectivity: 'Provar connexió',
    videoConnectivitySuccess: 'Servei de vídeo connectat correctament',
    videoConnectivityFailed: 'Error en la connexió del servei de vídeo',
    testingConnection: 'Provant...',
    videoTestSuccess: 'Prova de generació de vídeo correcta',
    videoTestFailed: 'Prova de generació de vídeo fallida',
    videoTestPromptDefault: 'Un gat maco caminant per un escriptori',
    videoGenerating: 'Generant vídeo (est. 1-2 min)...',
    videoGenerationWarning: 'La generació de vídeo normalment triga 1-2 minuts, tingueu paciència',
    mediaRetry: 'Reintentar',
    mediaContentSensitive: 'Ho sentim, aquest contingut ha activat una verificació de seguretat.',
    mediaGenerationDisabled: 'Generació desactivada a la configuració',
    // Agent settings (kept with main settings block above)
    singleAgent: 'Agent únic',
    multiAgent: 'Multi-agent',
    selectAgents: 'Seleccionar agents',
    noVisionWarning:
      'El model actual no suporta visió. Les imatges es poden posar a les diapositives, però el model no pot entendre el contingut de les imatges per optimitzar la selecció i el disseny',
    // Server provider configuration
    serverConfigured: 'Servidor',
    serverConfiguredNotice:
      'L\'administrador ha configurat una clau API per a aquest proveïdor al servidor. Podeu usar-la directament o introduir la vostra pròpia clau per sobreescriure-la.',
    optionalOverride: 'Opcional — deixeu buit per usar la configuració del servidor',
    // Access code
    setupNeeded: 'Cal configuració',
    modelNotConfigured: 'Seleccioneu un model per començar',
    // Clear cache
    dangerZone: 'Zona de perill',
    clearCache: 'Netejar caché local',
    clearCacheDescription:
      'Elimina totes les dades emmagatzemades localment, incloent registres d\'aula, historial de xat, caché d\'àudio i configuració de l\'aplicació. Aquesta acció no es pot desfer.',
    clearCacheConfirmTitle: 'Esteu segurs que voleu netejar tota la caché?',
    clearCacheConfirmDescription:
      'Això eliminarà permanentment totes les dades següents i no es podran recuperar:',
    clearCacheConfirmItems:
      'Aules i escenes, Historial de xat, Caché d\'àudio i imatges, Configuració i preferències de l\'aplicació',
    clearCacheConfirmInput: 'Escriviu "ELIMINAR" per continuar',
    ...
    webSearchApiKeyPlaceholder: 'Introduïu la vostra clau API Tavily',
    webSearchApiKeyPlaceholderServer: 'Clau del servidor configurada, podeu sobreescriure-la opcionalment',
    webSearchApiKeyHint: 'Obteniu una clau API de tavily.com per a la cerca web',
    webSearchBaseUrl: 'Base URL',
    webSearchServerConfigured: 'La clau API Tavily del costat del servidor està configurada',
    optional: 'Opcional',
    // Themes settings
    themesSettings: 'Temes',
    themes: {
      title: 'Temes',
      description: 'Gestiona els temes visuals del material generat',
      active: 'Actiu',
      activate: 'Activa',
      export: 'Exporta ZIP',
      upload: 'Puja ZIP',
      ...
      imported: 'Tema importat',
      confirmDelete: "Segur que vols eliminar aquest tema?",
      loadError: "No s'han pogut carregar els temes",
      deleteError: "No s'ha pogut eliminar el tema",
  ...
  profile: {
    title: 'Perfil',
    defaultNickname: 'Estudiant',
    chooseAvatar: 'Triar avatar',
    uploadAvatar: 'Pujar',
    bioPlaceholder: 'Expliqueu-nos alguna cosa de vosaltres — el professor IA personalitzarà les lliçons...',
    avatarHint: 'El vostre avatar apareixerà a les discussions i xats de l\'aula',
    fileTooLarge: 'Imatge massa gran — trieu-ne una de menys de 5 MB',
    invalidFileType: 'Seleccioneu un fitxer d\'imatge',
    editTooltip: 'Clic per editar el perfil',
  },
  media: {
    imageCapability: 'Generació d\'imatges',
    imageHint: 'Generar imatges a les diapositives',
    videoCapability: 'Generació de vídeo',
    videoHint: 'Generar vídeos a les diapositives',
    ttsCapability: 'Síntesi de veu',
    ttsHint: 'El professor IA parla en veu alta',
    asrCapability: 'Reconeixement de veu',
    asrHint: 'Entrada de veu per a la discussió',
    provider: 'Proveïdor',
    model: 'Model',
    voice: 'Veu',
    speed: 'Velocitat',
...
export const settingsEnUS = {
  settings: {
    ...
    themes: {
      title: 'Themes',
      description: 'Manage visual themes for generated material',
      active: 'Active',
      activate: 'Activate',
      export: 'Export ZIP',
      upload: 'Upload ZIP',
