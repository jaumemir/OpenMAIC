...
export const settingsCa = {
  settings: {
    ...
    addProviderDescription:
      'Afegiu proveïdors de models personalitzats per ampliar els models IA disponibles',
    providerNames: {
      openai: 'OpenAI',
      anthropic: 'Claude',
      google: 'Gemini',
    ...
    activeModelDescription:
      'Seleccioneu el model per a les converses IA i la generació de contingut',
    ...
    asrEnabledDescription:
      "Quan s'activa, els estudiants poden usar el micròfon per a l'entrada de veu",
    ...
    browserNativeNote:
      "L'ASR natiu del navegador no requereix configuració i és completament gratuït",
    // Audio provider names
    providerOpenAITTS: 'OpenAI TTS (gpt-4o-mini-tts)',
    providerAzureTTS: 'Azure TTS',
    providerAzureFoundryTTS: 'Azure AI Foundry TTS',
    ...
    webSearchApiKeyPlaceholderServer:
      'Clau del servidor configurada, podeu sobreescriure-la opcionalment',
  ...
  profile: {
    ...
    uploadAvatar: 'Pujar',
    bioPlaceholder:
      'Expliqueu-nos alguna cosa de vosaltres — el professor IA personalitzarà les lliçons...',
