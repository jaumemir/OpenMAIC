...
export const generationCa = {
  classroom: {
    ...
    regenerateAudioBrowserNativeUnsupported:
      "El TTS natiu del navegador no admet la regeneració massiva d'àudio de l'aula",
  },
  upload: {
  ...
  generation: {
    ...
    textTruncated:
      "El text del document és llarg, s'utilitzen els primers {n} caràcters per a la generació",
    imageTruncated:
