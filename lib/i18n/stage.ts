...
export const stageCa = {
  ...
  whiteboard: {
    title: 'Pissarra interactiva',
    open: 'Obrir pissarra',
    clear: 'Netejar pissarra',
    minimize: 'Minimitzar pissarra',
    ready: 'La pissarra està llesta',
    readyHint: 'Els elements apareixeran aquí quan els afegeixi la IA',
    clearSuccess: 'Pissarra netejada correctament',
    clearError: 'Error en netejar la pissarra: ',
    resetView: 'Restablir vista',
    restoreError: 'Error en restaurar la pissarra: ',
    history: 'Historial',
    restore: 'Restaurar',
    noHistory: 'Encara no hi ha historial',
    restored: 'Pissarra restaurada',
    elementCount: '{count} elements',
  },
  quiz: {
    title: 'Qüestionari',
    subtitle: 'Posa a prova els teus coneixements',
    questionsCount: 'preguntes',
    totalPrefix: '',
    pointsSuffix: 'pts',
    startQuiz: 'Iniciar qüestionari',
    multipleChoiceHint: '(Resposta múltiple — seleccioneu totes les respostes correctes)',
    inputPlaceholder: 'Escriviu la vostra resposta aquí...',
    charCount: 'caràcters',
    yourAnswer: 'La vostra resposta:',
    notAnswered: 'Sense resposta',
    aiComment: 'Comentari IA',
    singleChoice: 'Única',
    ...
    keepGoing: 'Continua!',
    needsReview: 'Cal repassar',
    correct: 'correcte',
    incorrect: 'incorrecte',
    answering: 'En curs',
    submitAnswers: 'Enviar respostes',
    aiGrading: 'La IA està corregint...',
    aiGradingWait: 'Espereu, analitzant les vostres respostes',
    quizReport: 'Informe del qüestionari',
    retry: 'Reintentar',
  },
  roundtable: {
    teacher: 'PROFESSOR',
    ...
    thinking: 'Pensant',
    yourTurn: 'El vostre torn',
    stopDiscussion: 'Aturar discussió',
    autoPlay: 'Reproducció automàtica',
    autoPlayOff: 'Aturar reproducció automàtica',
    speed: 'Velocitat',
    voiceInput: 'Entrada de veu',
    voiceInputDisabled: 'Entrada de veu desactivada',
  ...
  pbl: {
    ...
    workspace: {
      restart: 'Reiniciar',
      confirmRestart: 'Restablir tot el progrés?',
      confirm: 'Confirmar',
      cancel: 'Cancel·lar',
    },
    issueboard: {
      title: 'Tauler de tasques',
      noIssues: 'Encara no hi ha tasques',
      statusDone: 'Fet',
      statusActive: 'Actiu',
      statusPending: 'Pendent',
    },
    chat: {
      title: 'Discussió del projecte',
      currentIssue: 'Tasca actual',
      mentionHint: 'Useu @question per preguntar, @judge per enviar a revisió',
      placeholder: 'Escriviu un missatge...',
      send: 'Enviar',
      welcomeMessage:
        'Hola! Soc el vostre Agent de Preguntes per a aquesta tasca: "{title}"\n\nPer guiar el vostre treball, he preparat algunes preguntes:\n\n{questions}\n\nNo dubteu a fer-me @question qualsevol moment si necessiteu ajuda!',
      issueCompleteMessage: 'Tasca "{completed}" completada! Passant a la tasca següent: "{next}"',
      allCompleteMessage: '🎉 Totes les tasques completades! Bon treball en el projecte!',
    },
    guide: {
      ...
      title: 'Ajuda',
      step1: {
        title: 'Pas 1: Trieu un rol',
        desc: 'Després de generar el projecte, seleccioneu un rol de la llista (rols no de sistema marcats amb 🟢)',
      },
      step2: {
      ...
      step3: {
        title: 'Pas 3: Completeu el projecte',
        desc: 'Quan totes les tasques estiguin fetes, el sistema mostra "🎉 Projecte completat!"',
      },
    },
  },
  share: {
    notReady: 'Disponible quan la generació estigui completa',
  },
} as const;
